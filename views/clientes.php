                    ...
                    if (empty($clientes)) {
                        ...
                        foreach ($clientes as $cliente)
                            echo '<div  class="box-cliente"> '
                                .$cliente['nombre'].' '.$cliente['apellido'].' <br> '. $cliente['dni_cliente']. '<br>'.$cliente['descripcionCaso']. '<br>'.$cliente['caracteristicasMenu'].'</div>';
                    }
                ?>
            </article>
            <article id="calendar">
            ...
            <article id="recetas">
                ...
                <div id="fecha">
                    <form  action="" method="post">
                       ...
                       <input type="hidden" id="receta_id" name="receta_id">Add commentMore actions
